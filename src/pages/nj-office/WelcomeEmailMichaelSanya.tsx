...
const PROVIDER = {
  providerName: "Michael Sanya",
  bookingDate: "Saturday, March 21, 2026",
  appointmentTime: "11:00 AM",
  onboardingDate: "March 16, 2026",
...
export default function WelcomeEmailMichaelSanya() {
  ...
  const handleDownloadPng = async () => {
    ...
    try {
      ...
      link.download = "Welcome-Email-Michael-Sanya.png";
      link.href = dataUrl;
      link.click();
    } catch (e) {
    ...
    <div className="min-h-screen bg-[hsl(270,15%,96%)] font-body">
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-border/20">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <p className="text-xs font-semibold tracking-wide uppercase text-muted-foreground">Welcome Email — Michael Sanya</p>
      ...
      <div className="max-w-2xl mx-auto py-10 px-4">
        <div ref={emailRef} style={{ fontFamily: "'Montserrat', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", maxWidth: 600, margin: "0 auto", backgroundColor: "#ffffff" }}>
          ...
          <div style={{ padding: "36px 40px 20px" }}>
            ...
            <p style={{ color: "#1a1a2e", fontSize: 15, lineHeight: 1.7, margin: "0 0 18px" }}>
              Thank you so much for scheduling your first in-person office day at our New Jersey office on <strong>{PROVIDER.bookingDate}</strong> — we're thrilled to have you! 🎉
            </p>
            <p style={{ color: "#1a1a2e", fontSize: 15, lineHeight: 1.7, margin: "0 0 18px" }}>
            ...
            <ul style={{ color: "#1a1a2e", fontSize: 14, lineHeight: 1.7, margin: "0 0 18px", paddingLeft: 20 }}>
              {BOOKED_DATES.map((bd, i) => (
                <li key={i}>{bd.date} — <span style={{ color: "#7C3AED", fontWeight: 600 }}>{bd.location}</span></li>
              ))}
            </ul>
            <p style={{ color: "#1a1a2e", fontSize: 15, lineHeight: 1.7, margin: "0 0 18px" }}>
            ...
            <div style={{ margin: "24px 0" }}>
              ...
              <div style={{ background: "#F5F3FF", borderRadius: 12, padding: "20px 24px", marginBottom: 12, borderLeft: "4px solid #7C3AED" }}>
                ...
                <p style={{ color: "#1a1a2e", fontSize: 14, lineHeight: 1.6, margin: "0 0 10px" }}>
                  This will be circulated to you the night before your appointments with all of your scheduled patients.
                </p>
              ...
              {/* Office Agreement */}
              <div style={{ background: "#ECFDF5", borderRadius: 12, padding: "20px 24px", marginBottom: 12, borderLeft: "4px solid #10B981" }}>
                <p style={{ color: "#059669", fontSize: 11, fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.08em", margin: "0 0 6px" }}>✅ Office Agreement</p>
                <p style={{ color: "#1a1a2e", fontSize: 14, lineHeight: 1.6, margin: 0 }}>
                  Thank you for signing the office agreement — you're all set!
                </p>
              </div>
